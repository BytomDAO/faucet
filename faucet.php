...
?>
<h3>比原链测试网水龙头（BytomTestnetFaucet）</h3>
<font size="-2">
<p>请输入比原链测试网钱包地址（以字母tm起始）来领取测试币。<br>
Please input Bytom testnet address which is start from tm...</p>
...
echo '<p>返回<a href="http://test.blockmeta.com/faucet.php"></a></p>';
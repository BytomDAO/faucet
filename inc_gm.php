...
define('BTM_NODE_API_URL','http://0.0.0.0:9889/');  //此处配置你的比原API的访问地址
...
if(strcasecmp($gStrBtmNetworkId,'mainnet')==0){
  ...
  define('FUND_BTM_ADDRESS','gm1qfq3sznxmnvdng4r27p3vlzf3z72utg50kpvuzt'); //游戏发布者钱包地址
  define('BTM_NODE_API_TOKEN','');

  $gArrayNodeAccounts=array(  
    array('id'=>'0KN8NES7G0A02','pwd'=>'12345','address'=>'gm1qfq3sznxmnvdng4r27p3vlzf3z72utg50kpvuzt'), 
